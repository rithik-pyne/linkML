...
URI: [clinical_model:plasma_volume_ml](https://uk-cpi.com/clinical_model/plasma_volume_ml)
...
| ---  | ---  |
| self | clinical_model:plasma_volume_ml |
| native | clinical_model:plasma_volume_ml |
