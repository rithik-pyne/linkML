...
URI: [clinical_model:cfdna_concentration_ng_ul](https://uk-cpi.com/clinical_model/cfdna_concentration_ng_ul)
...
| ---  | ---  |
| self | clinical_model:cfdna_concentration_ng_ul |
| native | clinical_model:cfdna_concentration_ng_ul |
