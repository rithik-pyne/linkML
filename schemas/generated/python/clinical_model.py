...
class ResponseAssessment(ConfiguredBaseModel):
    ...
    patient_id: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Patient',
                       ...
                       'ClinicalAssessment',
                       'ImagingStudy']} })
    treatment_id: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Treatment', 'ResponseAssessment']} })
    imaging_study_id: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['ResponseAssessment', 'ImagingStudy']} })
    molecular_test_id: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['MolecularTest', 'Mutation', 'ResponseAssessment']} })
