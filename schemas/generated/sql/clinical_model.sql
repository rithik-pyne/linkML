...
-- # Class: ResponseAssessment Description: Serial treatment response monitoring (RECIST + ctDNA) - multiple rows per patient
--     * Slot: assessment_id
--     * Slot: patient_id
--     * Slot: treatment_id
...
CREATE INDEX "ix_ResponseAssessment_assessment_id" ON "ResponseAssessment" (assessment_id);
